...
<!-- Phase 1 경계 메모: service_lock만 WARN+confirm으로 완화됨.
     untracked_overwrite, main 전환 실패, 소유권 불일치 등 다른 precheck는 hard stop 유지.
     severity 변경 이력: FAILED→WARN(2026-04-24, fix-merge-test-service-lock-warning-confirm-runtime-boundary).
