...
- **touched whitelist dirty**: `TODO.md`, `docs/DONE.md`, plans `docs/plan/*.md`, plans `docs/archive/*.md` 안에서 `$TouchedPaths`와 현재 dirty가 만나는 path. 성공 종료 전 exact path set으로 커밋해야 하며, 커밋할 수 없으면 hard-fail한다.
