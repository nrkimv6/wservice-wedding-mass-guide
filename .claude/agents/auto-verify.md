...
1. plan 문서를 읽는다
2. `_verify-checklist.md` (`wtools/.claude/docs/_verify-checklist.md`)의 V1~V6 체크리스트를 순회한다
...
상세 항목은 `wtools/.claude/docs/_verify-checklist.md`를 참조한다. 요약:
...
| V6 | 번호 충돌, 중복 항목, Phase 누락 등 메타 오류가 있는가 | Read |
